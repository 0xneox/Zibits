...
<br></br><br/>‍   </p>
          ...
          <div className="lg:w-/2 w-/4">
                    ...
                    <p className="text-blau Montserrat-Light text-2xl"> We are no ?
                    </p>
                ...
                <div className="lg:w-/2 w-/4">
                    ...
                    <p className="text-blau Montserrat-Light text-2xl"> We are not pitching an NF?
                    </p>
                     <p className="text-xl text-white my-6  Poppitandfinch"> A universal accept reservation system in the Metaverse in which sysndicate pass access as a security check-in for filtering junks. Zib1 syndicate pass holders can redeem all future drops without spending gas fee.
</p>
                    </div>
          ...
          <div className="lg:w-/2 w-/4">
                    ...
                    <p className="text-blau Montserrat-Light text-2xl"> We are not pitc ?
                    </p>
                     <p className="text-xl text-white my-6  Poppitandfinch"> A universal accept reservation system in the Metaverse in which sysndicate pass access as a security check-in for filtering junks. Zib1 syndicate pass holders can redeem all future drops without spending gas fee.
</p>
                    </div>
          ...
          <div className="lg:w-/2 w-/4">
                    ...
                    <p className="text-blau Montserrat-Light text-2xl"> We are not pitching an ?
                    </p>
                     <p className="text-xl text-white my-6  Poppitandfinch"> A universal accept reservation system in the Metaverse in which sysndicate pass access as a security check-in for filtering junks. Zib1 syndicate pass holders can redeem all future drops without spending gas fee.
</p>
                    </div>
          ...
          <div className="lg:w-/2 w-/4">
                    ...
                    <p className="text-blau Montserrat-Light text-2xl"> We are not pitchding. ?
                    </p>
                     <p className="text-xl text-white my-6  Poppitandfinch"> A universal accept reservation system in the Metaverse in which sysndicate pass access as a security check-in for filtering junks. Zib1 syndicate pass holders can redeem all future drops without spending gas fee.
</p>
                    </div>
