         ...
         " key="twdesc" />
          ...
          <div >
            <div className="flex items-center justify-between w-full border-b-2	pb-6">
              <a href="/" className=""><img src="images/502.svg" width="108" alt="" className="logo-image" /></a><span></span>
              <nav className="flex flex-wrap flex-row justify-around Poppitandfinchsans">
                ...
                <a href="/roadmap" className="text-2xl Poppitandfinchsans text-white hover:text-black m-6">Docs</a>
...
The Maya script was a logosyllabic system with some syllabogrammatic elements. Individual glyphs or symbols could represent either a morpheme or a syllable, and the same glyph could often be used for both.
          ...
          <div className="lg:w-/2 w-/4">
                ...
                <div id="traits" className="flex flex-wrap justify-around items-center  mx-6 py-6">
                <div className="border-4 border-blue-300 p-4"><img src="images/1.svg" alt="" width="100px" className="feature-image"/></div>
                <div className="border-4 border-blue-300 p-4"><img src="images/2.svg" alt="" width="100px" className="feature-image"/></div>
                <div className="border-4 border-blue-300 p-4"><img src="images/3.svg" alt="" width="100px" className="feature-image"/></div>
                <div className="border-4 border-blue-300 p-4"><img src="images/4.svg" alt="" width="100px" className="feature-image"/></div>
                <div className="border-4 border-blue-300 p-4"><img src="images/5.svg" alt="" width="100px" className="feature-image"/></div>
                <div className="border-4 border-blue-300 p-4"><img src="images/6.svg" alt="" width="100px" className="feature-image"/></div>
                </div><div id="traits" className="flex flex-wrap justify-around items-center  mx-6 py-6">
                <div className="border-4 border-blue-300 p-4"><img src="images/7.svg" alt="" width="100px" className="feature-image"/></div>
                <div className="border-4 border-blue-300 p-4"><img src="images/8.svg" alt="" width="100px" className="feature-image"/></div>
                <div className="border-4 border-blue-300 p-4"><img src="images/9.svg" alt="" width="100px" className="feature-image"/></div>
                <div className="border-4 border-blue-300 p-4"><img src="images/10.svg" alt="" width="100px" className="feature-image"/></div>
                <div className="border-4 border-blue-300 p-4"><img src="images/11.svg" alt="" width="100px" className="feature-image"/></div>
                <div className="border-4 border-blue-300 p-4"><img src="images/6.svg" alt="" width="100px" className="feature-image"/></div>
                </div>
          ...
          <div className="lg:w-/2 w-/4">
                ...
                <div id="traits" className="flex flex-wrap justify-around  mx-6 py-6">
                    ...
                    <br></br>
                    <p className="text-xl text-white my-6  Montserrat-Light"> Drop us a line at <a className="text-blau underline font-bold" target="_blank" href="mailto:mayanpunk@pm.me">mayanpunk@pm.me</a>,<br/>
          ...
          <div className="flex items-center justify-between w-full border-b-2	pb-6">
            ...
            <nav className="flex flex-wrap flex-row justify-around Poppitandfinchsans">
              <a href="#Shome" className="text-2xl Poppitandfinchsans text-white hover:text-black m-6">Home</a>
              <a href="/about" className="text-2xl Poppitandfinchsans text-white hover:text-black m-6">Collection</a>
              <a href="/mint" className="text-2xl Poppitandfinchsans text-white hover:text-black m-6">Mint</a>
              <a href="/faq" className="text-2xl Poppitandfinchsans text-white hover:text-black m-6">FAQ</a>
              <a href="/userguide" className="text-2xl Poppitandfinchsans text-white hover:text-black m-6">User Guide</a>
              <a href="/mintguide" className="text-2xl Poppitandfinchsans text-white hover:text-black m-6">Mint Guide</a>
              <a href="/mintguide" className="text-2xl Poppitandfinchsans text-white hover:text-black m-6">Onchain</a>

              <a href="https://github.com/Mayanpunk" className="text-2xl Poppitandfinchsans text-blau   m-6">Discord</a>
              <a href="https://github.com/Mayanpunk" className="text-2xl Poppitandfinchsans text-blau  m-6">Twitter</a>
