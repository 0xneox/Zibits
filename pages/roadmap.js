        ...
        <div className="md:w-2/3 w-4/5 " id="about">
            ...
            <div className="flex flex-wrap lg:flex-nowrap justify-around items-center">
                  <div className="lg:w-1/2 w-3/4">
                    <h1 className="text-4xl montserrat text-white ">Roadmap </h1>
          ...
          <div className="lg:w-/2 w-/4">
                    ...
                    <p className="text-blau Montserrat-Light text-2xl"> 20%
                    </p>
          ...
          <div className="lg:w-/2 w-/4">
                    ...
                    <p className="text-blau Montserrat-Light text-2xl"> 40%
                    </p>
          ...
          <div className="lg:w-/2 w-/4">
                    ...
                    <p className="text-blau Montserrat-Light text-2xl"> 50%
                    </p>
          ...
          <div className="lg:w-/2 w-/4">
                    ...
                    <p className="text-blau Montserrat-Light text-2xl">70%
                    </p>
...
The MayanPunk smart contract is limited to 10,000 Mayans, so grab yours ASAP!
          ...
          <div className="lg:w-/2 w-/4">
                    ...
                    <p className="text-blau Montserrat-Light text-2xl"> 90%
                    </p>
          ...
          <p className="text-blau Montserrat-Light text-2xl">100%
                    </p>
